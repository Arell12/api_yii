...
class SolicitudesController extends ActiveController
{
    public $modelClass = 'app\models\Solicitudes';
    ...
    public function actionTotal($text="") {
        $total = Solicitudes::find()->joinWith(['empleado','estado']);
    ...
    if ($text != '') {
        ...
        foreach ($palabras as $palabra) {
            ...
            $total->andWhere([
                ...
                ['like', new \yii\db\Expression("LOWER(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(nombre_estado, 'á', 'a'), 'é', 'e'), 'í', 'i'), 'ó', 'o'), 'ú', 'u'))"), $palabra],
            ]);
        }
    }
        $total = $total->count();
    ...
    public function actionBuscar($text)
{
    ...
    $consulta = Solicitudes::find()->joinWith(['empleado','estado']);
