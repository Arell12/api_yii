...
class NotificacionesController extends ActiveController
{
...
public function actionTotal($text="") {
    $total = Notificaciones::find()->joinWith(['empleado','tiponotificacion']);
    ...
    if ($text != '') {
        ...
        foreach ($palabras as $palabra) {
            ...
            $total->andWhere([
                ...
                ['like', new \yii\db\Expression("LOWER(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(tipo, 'á', 'a'), 'é', 'e'), 'í', 'i'), 'ó', 'o'), 'ú', 'u'))"), $palabra]
            ]);
        }
    }
...
public function actionBuscar($text)
{
    ...
    $consulta = Notificaciones::find()->joinWith(['empleado', 'tiponotificacion']);
    ...
    $notificaciones = new ActiveDataProvider([
        'query' => $consulta,
        'pagination' => [
    ...
    return $notificaciones->getModels();
}
}
